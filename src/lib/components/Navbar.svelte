...
>
  <a
    ...
    class="flex h-8 w-fit items-center gap-1.5 p-1.5 font-display text-lg font-medium hover:bg-neutral-200 transition-colors"
  ...
  <button
    ...
    class="sm:hidden size-8 grid place-items-center"
    ><img
  ...
  >
  <ul
    class="hidden sm:flex sm:gap-2 sm:text-sm sm:font-medium sm:text-neutral-800 sm:uppercase"
  >
